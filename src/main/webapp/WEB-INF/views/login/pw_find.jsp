...
<jsp:include page="../js/pw_find_js.jsp"/>
<!-- 비밀번호 변경 페이지 -->
...
<div align="center" style="margin-top: 40px;">
   ...
   <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
     ...
     <div class="buttons">
      ...
      <div class="form-img">
      <a href="https://kauth.kakao.com/oauth/authorize?client_id=${kakao_login}&redirect_uri=${redirect_url}/login/pw_find.do&response_type=code&scope=talk_message" class="center-img">
